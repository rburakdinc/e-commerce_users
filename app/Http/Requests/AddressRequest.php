...
class AddressRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "district.min" => "Bu alan en az 5 karakterden oluşmalıdır.",
            "zipcode.required" => "Bu alan zorunludur.",
            "zipcode.min" => "Bu alan en az 5 karakterden oluşmalıdır.",
            "address.required" => "Bu alan zorunludur.",
            "address.min" => "Bu alan en az 15 karakterden oluşmalıdır.",
        ];
    }
}
